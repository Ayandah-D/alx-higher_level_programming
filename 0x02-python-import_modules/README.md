...
```
ayandah@ubuntu:~/0x02$ cat add_0.py
#!/usr/bin/python3
def add(a, b):
...
ayandah@ubuntu:~/0x02$ ./0-add.py
1 + 2 = 3
ayandah@ubuntu:~/0x02$ cat 0-import_add.py
__import__("0-add")
ayandah@ubuntu:~/0x02$ python3 0-import_add.py 
ayandah@ubuntu:~/0x02$ 
```
- Write a program that imports functions from the file calculator_1.py, does some Maths, and prints the result.
```
ayandah@ubuntu:~/0x02$ cat calculator_1.py
#!/usr/bin/python3
def add(a, b):
    """My addition function
...
ayandah@ubuntu:~/0x02$ ./1-calculation.py
10 + 5 = 15
10 - 5 = 5
10 * 5 = 50
10 / 5 = 2
...
```
ayandah@ubuntu:~/0x02$ ./2-args.py 
0 arguments.
ayandah@ubuntu:~/0x02$ ./2-args.py Hello
1 argument:
1: Hello
ayandah@ubuntu:~/0x02$ ./2-args.py Hello Welcome To The Best School
6 arguments:
1: Hello
2: Welcome
3: To
...
```
ayandah@ubuntu:~/0x02$ curl -Lso "hidden_4.pyc" "https://github.com/holbertonschool/0x02.py/raw/master/hidden_4.pyc"
ayandah@ubuntu:~/0x02$ ./4-hidden_discovery.py | sort
my_secret_santa
print_hidden
print_school
ayandah@ubuntu:~/0x02$ 
...
```
ayandah@ubuntu:~/0x02$ cat variable_load_5.py
#!/usr/bin/python3
a = 98
"""Simple variable
"""

ayandah@ubuntu:~/0x02$ ./5-variable_load.py
98
ayandah@ubuntu:~/0x02$
```
...
ayandah@ubuntu:~/0x02$ ./100-my_calculator.py ; echo $?
Usage: ./100-my_calculator.py <a> <operator> <b>
1
ayandah@ubuntu:~/0x02$ ./100-my_calculator.py 3 + 5 ; echo $?
3 + 5 = 8
0
ayandah@ubuntu:~/0x02$ ./100-my_calculator.py 3 H 5 ; echo $?
...
```
ayandah@ubuntu:~/0x02$ ./101-easy_print.py
#pythoniscool
ayandah@ubuntu:~/0x02$ 
```
...
```
ayandah@ubuntu:~/0x02$ ./103-fast_alphabet.py
ABCDEFGHIJKLMNOPQRSTUVWXYZ
ayandah@ubuntu:~/0x02$ wc -l 103-fast_alphabet.py
